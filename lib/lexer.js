  ...
  while (true) {
    ...
    // Instance variables
      ...
      switch (scanner.matched()) {
        ...
        // case 'elsif':
          // return ['kELSEIF', scanner.matched()];
        case 'else':
          this.lex_state = EXPR_BEG;
        ...
        case 'isnt':
          return ['!==', scanner.matched()];
        case 'try':
          return ['kTRY', scanner.matched()];
        case 'catch':
          if (this.lex_state == EXPR_BEG) {
            return ['CATCH', scanner.matched()];
          }
          this.lex_state = EXPR_BEG;
          return ['CATCH_MOD', scanner.matched()];
        case 'finally':
        ...
        case 'continue':
          this.lex_state = EXPR_BEG;
          return ['CONTINUE', scanner.matched()];
        case 'new':
          return ['NEW', scanner.matched()];
        case 'unless':
          if (this.lex_state == EXPR_BEG) {
