...
var Grammar = {
  ...
  MethodCall: [
    ...
    ["YIELD",                                                                   "$$ = ['yield', null];"],
    ["REQUIRE STRING_BEGIN STRING_CONTENT STRING_END",                          "$$ = ['require', $3];"]
  ],
  ...
  Class: [
    ...
    ["CLASS << Expression Term BodyStatements END",                             "$$ = ['class_shift', $3, $5];"],
  ...
  DefObjjArgs: [
    ["LABEL IDENTIFIER",                                                        "$$=[[$1, $2]];"],
    ["DefObjjArgs , LABEL IDENTIFIER",                                          "$$ = $1.concat([[$3, $4]]);"]
  ],
